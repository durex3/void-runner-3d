...
export const HEROES={
  Knight:{label:'骑士',description:'剑盾防守、重剑清场与钉锤打断',weapons:[
    ...
    {label:'震击钉锤',model:'Skeleton_Mace',type:3,damage:52,interval:.8,range:3,arc:90,delay:.25*(.8/.9),stagger:.45,grip:'melee',effect:'melee',animation:'Melee_1H_Attack_Chop',stance:'Idle_A',detail:'近身震击 · 普通敌人硬直 0.45 秒'}]},
