...
文档同步日期：2026-09-18。其他说明：[项目架构](./ARCHITECTURE.md) · [武器素材清单](./武器素材清单.md) · [素材方案与后续计划](./素材方案.md) · [美术来源与许可](./ART-CREDITS.md) · [原素材目录](./references/purchased/README.md)。
...
远程武器已接入第一版轻量反馈：发射闪光、命中贴图、自然范围、雷电节点和魔杖溅射提示分别按武器类型显示；不改变伤害和攻速。新增反馈使用已购买 Combat FX 1.1 与 Kenney Particle Pack，原始 ZIP 不进入仓库。后续再按工程师、游侠、德鲁伊分批细化枪口、弹道、命中、机制辨识与专属音色。新关卡、敌人预警与波次节奏在远程反馈完成后评估。
