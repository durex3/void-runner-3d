...
场景为程序化遗迹，边界实例化绘制，搭配 Kenney CC0 树岩。骑士三种近战使用 Kenney Particle Pack 的精选贴图，分别表现快速斩击、重斩扬尘和钉锤冲击；效果在真实伤害结算时触发。角色共享几何体/贴图、独立骨骼；死亡实例 1.6 秒清理。像素比上限 1.6，装置 24、战利品 36、玩家弹丸 160、粒子/临时线 180。来源与许可见 `ART-CREDITS.md`。
